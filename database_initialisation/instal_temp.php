...
$link_temp = mysqli_connect("127.0.0.1", "admin", "it103");
...
$link = mysqli_connect("127.0.0.1", "admin", "it103", "Random_Fishermen");
...
if($query_tables = mysqli_multi_query($link,$tables)){
	mysqli_close($link);
	$link2 = mysqli_connect("127.0.0.1", "admin", "it103", "Random_Fishermen");
